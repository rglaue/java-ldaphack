 ...
 * extended all references should be to AttributeTypeManager
 */
public abstract class BaseAttributeTypeManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.AttributeType";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.AttributeTypeManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of AttributeTypeManager.
     */
    public static AttributeTypeManager getManager()
    {
        return (AttributeTypeManager)
            Torque.getManager(AttributeTypeManager.MANAGED_CLASS,
                AttributeTypeManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>AttributeType</code> value
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeType getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached AttributeTypes before loading
     * from storage.
     * @return a <code>AttributeType</code> value
     * @exception TorqueException if an error occurs
     */
    public static AttributeType getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeType getInstance(Integer id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeType getInstance(Integer id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(AttributeType obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseAttributeTypeManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseAttributeTypeManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.AttributeType");
    }

    /**
     * Get a fresh instance of a AttributeTypeManager
     */
    protected AttributeType getInstanceImpl()
        throws TorqueException
    {
        AttributeType obj = null;
        try
        {
            obj = (AttributeType) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected AttributeType getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (AttributeType) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected AttributeType getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (AttributeType) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of AttributeTypes based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of AttributeTypes
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(AttributeType om)
        throws TorqueException
    {
        Criteria crit = AttributeTypePeer
            .buildCriteria((AttributeType)om);
        return AttributeTypePeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return AttributeTypePeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return AttributeTypePeer.retrieveByPKs(ids);
    }
}
