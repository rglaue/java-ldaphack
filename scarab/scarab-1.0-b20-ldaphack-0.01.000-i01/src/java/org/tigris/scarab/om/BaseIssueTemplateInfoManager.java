 ...
 * extended all references should be to IssueTemplateInfoManager
 */
public abstract class BaseIssueTemplateInfoManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.IssueTemplateInfo";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.IssueTemplateInfoManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of IssueTemplateInfoManager.
     */
    public static IssueTemplateInfoManager getManager()
    {
        return (IssueTemplateInfoManager)
            Torque.getManager(IssueTemplateInfoManager.MANAGED_CLASS,
                IssueTemplateInfoManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>IssueTemplateInfo</code> value
     ...
     * @exception TorqueException if an error occurs
     */
    public static IssueTemplateInfo getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached IssueTemplateInfos before loading
     * from storage.
     * @return a <code>IssueTemplateInfo</code> value
     * @exception TorqueException if an error occurs
     */
    public static IssueTemplateInfo getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static IssueTemplateInfo getInstance(Long id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static IssueTemplateInfo getInstance(Long id, boolean fromCache)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseIssueTemplateInfoManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseIssueTemplateInfoManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.IssueTemplateInfo");
    }

    /**
     * Get a fresh instance of a IssueTemplateInfoManager
     */
    protected IssueTemplateInfo getInstanceImpl()
        throws TorqueException
    {
        IssueTemplateInfo obj = null;
        try
        {
            obj = (IssueTemplateInfo) getOMInstance();
        }
        catch (Exception e)
        {
    ...
    /**
     * Get a IssueTemplateInfo with the given id.
     *
     * @param id <code>ObjectKey</code> value
     */
    protected IssueTemplateInfo getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (IssueTemplateInfo) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected IssueTemplateInfo getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (IssueTemplateInfo) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of IssueTemplateInfos based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of IssueTemplateInfos
     * @exception TorqueException if an error occurs
     */
    ...
    protected boolean existsImpl(IssueTemplateInfo om)
        throws TorqueException
    {
        Criteria crit = IssueTemplateInfoPeer
            .buildCriteria((IssueTemplateInfo)om);
        return IssueTemplateInfoPeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return IssueTemplateInfoPeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return IssueTemplateInfoPeer.retrieveByPKs(ids);
    }
}
