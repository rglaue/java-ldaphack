 ...
 * extended all references should be to RModuleAttributeManager
 */
public abstract class BaseRModuleAttributeManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.RModuleAttribute";
     ...
     * the configuration.
     *
     * @return an implementation of RModuleAttributeManager.
     */
    public static RModuleAttributeManager getManager()
    {
        return (RModuleAttributeManager)
            Torque.getManager(RModuleAttributeManager.MANAGED_CLASS,
                RModuleAttributeManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>RModuleAttribute</code> value
     * @exception TorqueException if an error occurs
     */
    public static RModuleAttribute getInstance()
     ...
     * @exception TorqueException if an error occurs
     */
    public static RModuleAttribute getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached RModuleAttributes before loading
     * from storage.
     * @return a <code>RModuleAttribute</code> value
     * @exception TorqueException if an error occurs
     */
    public static RModuleAttribute getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(RModuleAttribute obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseRModuleAttributeManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseRModuleAttributeManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.RModuleAttribute");
    }

    /**
     * Get a fresh instance of a RModuleAttributeManager
     */
    protected RModuleAttribute getInstanceImpl()
        throws TorqueException
    {
        RModuleAttribute obj = null;
        try
        {
            obj = (RModuleAttribute) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected RModuleAttribute getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (RModuleAttribute) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected RModuleAttribute getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (RModuleAttribute) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of RModuleAttributes based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of RModuleAttributes
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(RModuleAttribute om)
        throws TorqueException
    {
        Criteria crit = RModuleAttributePeer
            .buildCriteria((RModuleAttribute)om);
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return RModuleAttributePeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return RModuleAttributePeer.retrieveByPKs(ids);
    }
}
