 ...
 * extended all references should be to AttributeManager
 */
public abstract class BaseAttributeManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.Attribute";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.AttributeManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of AttributeManager.
     */
    public static AttributeManager getManager()
    {
        return (AttributeManager)
            Torque.getManager(AttributeManager.MANAGED_CLASS,
                AttributeManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>Attribute</code> value
     ...
     * @exception TorqueException if an error occurs
     */
    public static Attribute getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached Attributes before loading
     * from storage.
     * @return a <code>Attribute</code> value
     * @exception TorqueException if an error occurs
     */
    public static Attribute getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Attribute getInstance(Integer id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(Attribute obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseAttributeManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseAttributeManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.Attribute");
    }

    /**
     * Get a fresh instance of a AttributeManager
     */
    protected Attribute getInstanceImpl()
        throws TorqueException
    {
        Attribute obj = null;
        try
        {
            obj = (Attribute) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected Attribute getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Attribute) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected Attribute getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (Attribute) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of Attributes based on id's.
     *
     ...
     */
    protected boolean existsImpl(Attribute om)
        throws TorqueException
    {
        Criteria crit = AttributePeer
            .buildCriteria((Attribute)om);
        return AttributePeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return AttributePeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return AttributePeer.retrieveByPKs(ids);
    }
}
