 ...
 * extended all references should be to AttachmentManager
 */
public abstract class BaseAttachmentManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.Attachment";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.AttachmentManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of AttachmentManager.
     */
    public static AttachmentManager getManager()
    {
        return (AttachmentManager)
            Torque.getManager(AttachmentManager.MANAGED_CLASS,
                AttachmentManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>Attachment</code> value
     ...
     * @exception TorqueException if an error occurs
     */
    public static Attachment getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached Attachments before loading
     * from storage.
     * @return a <code>Attachment</code> value
     * @exception TorqueException if an error occurs
     */
    public static Attachment getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Attachment getInstance(Long id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Attachment getInstance(Long id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(Attachment obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseAttachmentManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseAttachmentManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.Attachment");
    }

    /**
     * Get a fresh instance of a AttachmentManager
     */
    protected Attachment getInstanceImpl()
        throws TorqueException
    {
        Attachment obj = null;
        try
        {
            obj = (Attachment) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected Attachment getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Attachment) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected Attachment getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (Attachment) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of Attachments based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of Attachments
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(Attachment om)
        throws TorqueException
    {
        Criteria crit = AttachmentPeer
            .buildCriteria((Attachment)om);
        return AttachmentPeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return AttachmentPeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return AttachmentPeer.retrieveByPKs(ids);
    }
}
