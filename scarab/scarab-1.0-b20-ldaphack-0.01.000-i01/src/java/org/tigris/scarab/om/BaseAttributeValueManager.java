 ...
 * extended all references should be to AttributeValueManager
 */
public abstract class BaseAttributeValueManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.AttributeValue";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.AttributeValueManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of AttributeValueManager.
     */
    public static AttributeValueManager getManager()
    {
        return (AttributeValueManager)
            Torque.getManager(AttributeValueManager.MANAGED_CLASS,
                AttributeValueManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>AttributeValue</code> value
     * @exception TorqueException if an error occurs
     */
    public static AttributeValue getInstance()
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeValue getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached AttributeValues before loading
     * from storage.
     * @return a <code>AttributeValue</code> value
     * @exception TorqueException if an error occurs
     */
    public static AttributeValue getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeValue getInstance(Long id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeValue getInstance(Long id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(AttributeValue obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseAttributeValueManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseAttributeValueManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.AttributeValue");
    }

    /**
     * Get a fresh instance of a AttributeValueManager
     */
    protected AttributeValue getInstanceImpl()
        throws TorqueException
    {
        AttributeValue obj = null;
        try
        {
            obj = (AttributeValue) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected AttributeValue getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (AttributeValue) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected AttributeValue getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (AttributeValue) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of AttributeValues based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of AttributeValues
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(AttributeValue om)
        throws TorqueException
    {
        Criteria crit = AttributeValuePeer
            .buildCriteria((AttributeValue)om);
        return AttributeValuePeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return AttributeValuePeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return AttributeValuePeer.retrieveByPKs(ids);
    }
}
