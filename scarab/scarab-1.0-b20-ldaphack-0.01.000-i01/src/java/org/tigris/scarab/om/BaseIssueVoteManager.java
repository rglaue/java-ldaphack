...
/**
 * This class manages IssueVote objects.
 * This class was autogenerated by Torque  *
 * You should not use this class directly.  It should not even be
 * extended all references should be to IssueVoteManager
 */
public abstract class BaseIssueVoteManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.IssueVote";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.IssueVoteManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of IssueVoteManager.
     */
    public static IssueVoteManager getManager()
    {
        return (IssueVoteManager)
            Torque.getManager(IssueVoteManager.MANAGED_CLASS,
                IssueVoteManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>IssueVote</code> value
     * @exception TorqueException if an error occurs
     */
    public static IssueVote getInstance()
     ...
     * @exception TorqueException if an error occurs
     */
    public static IssueVote getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached IssueVotes before loading
     * from storage.
     * @return a <code>IssueVote</code> value
     * @exception TorqueException if an error occurs
     */
    public static IssueVote getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(IssueVote obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseIssueVoteManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseIssueVoteManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.IssueVote");
    }

    /**
     * Get a fresh instance of a IssueVoteManager
     */
    protected IssueVote getInstanceImpl()
        throws TorqueException
    {
        IssueVote obj = null;
        try
        {
            obj = (IssueVote) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected IssueVote getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (IssueVote) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected IssueVote getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (IssueVote) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of IssueVotes based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of IssueVotes
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(IssueVote om)
        throws TorqueException
    {
        Criteria crit = IssueVotePeer
            .buildCriteria((IssueVote)om);
        return IssueVotePeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return IssueVotePeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return IssueVotePeer.retrieveByPKs(ids);
    }
}
