 ...
 * extended all references should be to ActivitySetManager
 */
public abstract class BaseActivitySetManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.ActivitySet";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.ActivitySetManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of ActivitySetManager.
     */
    public static ActivitySetManager getManager()
    {
        return (ActivitySetManager)
            Torque.getManager(ActivitySetManager.MANAGED_CLASS,
                ActivitySetManager.DEFAULT_MANAGER_CLASS);
    }
     ...
     * @exception TorqueException if an error occurs
     */
    public static ActivitySet getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached ActivitySets before loading
     * from storage.
     * @return a <code>ActivitySet</code> value
     * @exception TorqueException if an error occurs
     */
    public static ActivitySet getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static ActivitySet getInstance(Long id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static ActivitySet getInstance(Long id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(ActivitySet obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseActivitySetManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseActivitySetManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.ActivitySet");
    }

    /**
     * Get a fresh instance of a ActivitySetManager
     */
    protected ActivitySet getInstanceImpl()
        throws TorqueException
    {
        ActivitySet obj = null;
        try
        {
            obj = (ActivitySet) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected ActivitySet getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (ActivitySet) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected ActivitySet getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (ActivitySet) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of ActivitySets based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of ActivitySets
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(ActivitySet om)
        throws TorqueException
    {
        Criteria crit = ActivitySetPeer
            .buildCriteria((ActivitySet)om);
        return ActivitySetPeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return ActivitySetPeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return ActivitySetPeer.retrieveByPKs(ids);
    }
}
