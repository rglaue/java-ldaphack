 ...
 * extended all references should be to IssueTypeManager
 */
public abstract class BaseIssueTypeManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.IssueType";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.IssueTypeManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of IssueTypeManager.
     */
    public static IssueTypeManager getManager()
    {
        return (IssueTypeManager)
            Torque.getManager(IssueTypeManager.MANAGED_CLASS,
                IssueTypeManager.DEFAULT_MANAGER_CLASS);
    }
     ...
     * @exception TorqueException if an error occurs
     */
    public static IssueType getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached IssueTypes before loading
     * from storage.
     * @return a <code>IssueType</code> value
     * @exception TorqueException if an error occurs
     */
    public static IssueType getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static IssueType getInstance(Integer id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static IssueType getInstance(Integer id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(IssueType obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseIssueTypeManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseIssueTypeManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.IssueType");
    }

    /**
     * Get a fresh instance of a IssueTypeManager
     */
    protected IssueType getInstanceImpl()
        throws TorqueException
    {
        IssueType obj = null;
        try
        {
            obj = (IssueType) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected IssueType getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (IssueType) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected IssueType getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (IssueType) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of IssueTypes based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of IssueTypes
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(IssueType om)
        throws TorqueException
    {
        Criteria crit = IssueTypePeer
            .buildCriteria((IssueType)om);
        return IssueTypePeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return IssueTypePeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return IssueTypePeer.retrieveByPKs(ids);
    }
}
