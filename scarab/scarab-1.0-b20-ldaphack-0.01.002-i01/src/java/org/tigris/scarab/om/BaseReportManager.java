    ...
    extends AbstractBaseManager
{
     ...
     * @exception TorqueException if an error occurs
     */
    public static Report getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached Reports before loading
     * from storage.
     * @return a <code>Report</code> value
     * @exception TorqueException if an error occurs
     */
    public static Report getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Report getInstance(Integer id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Report getInstance(Integer id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(Report obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseReportManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseReportManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.Report");
    }

    /**
     * Get a fresh instance of a ReportManager
     */
    protected Report getInstanceImpl()
        throws TorqueException
    {
        Report obj = null;
        try
        {
            obj = (Report) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected Report getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Report) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected Report getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (Report) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of Reports based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of Reports
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(Report om)
        throws TorqueException
    {
        Criteria crit = ReportPeer
            .buildCriteria((Report)om);
        return ReportPeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return ReportPeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return ReportPeer.retrieveByPKs(ids);
    }
}
