...
/**
 * This class manages ROptionOption objects.
 * This class was autogenerated by Torque  *
 * You should not use this class directly.  It should not even be
 * extended all references should be to ROptionOptionManager
 */
public abstract class BaseROptionOptionManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.ROptionOption";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.ROptionOptionManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of ROptionOptionManager.
     */
    public static ROptionOptionManager getManager()
    {
        return (ROptionOptionManager)
            Torque.getManager(ROptionOptionManager.MANAGED_CLASS,
                ROptionOptionManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>ROptionOption</code> value
     ...
     * @exception TorqueException if an error occurs
     */
    public static ROptionOption getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached ROptionOptions before loading
     * from storage.
     * @return a <code>ROptionOption</code> value
     * @exception TorqueException if an error occurs
     */
    public static ROptionOption getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(ROptionOption obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseROptionOptionManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseROptionOptionManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.ROptionOption");
    }

    /**
     * Get a fresh instance of a ROptionOptionManager
     */
    protected ROptionOption getInstanceImpl()
        throws TorqueException
    {
        ROptionOption obj = null;
        try
        {
            obj = (ROptionOption) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected ROptionOption getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (ROptionOption) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected ROptionOption getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (ROptionOption) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of ROptionOptions based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of ROptionOptions
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(ROptionOption om)
        throws TorqueException
    {
        Criteria crit = ROptionOptionPeer
            .buildCriteria((ROptionOption)om);
        return ROptionOptionPeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return ROptionOptionPeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return ROptionOptionPeer.retrieveByPKs(ids);
    }
}
