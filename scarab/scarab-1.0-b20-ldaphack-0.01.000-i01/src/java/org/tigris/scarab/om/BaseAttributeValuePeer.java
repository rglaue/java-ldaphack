...
/**
 */
public abstract class BaseAttributeValuePeer
    extends BasePeer
{
    ...
    public static final String TABLE_NAME = "SCARAB_ISSUE_ATTRIBUTE_VALUE";
    ...
    {
        return getMapBuilder(AttributeValueMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
          VALUE_ID = "SCARAB_ISSUE_ATTRIBUTE_VALUE.VALUE_ID";
          ISSUE_ID = "SCARAB_ISSUE_ATTRIBUTE_VALUE.ISSUE_ID";
          ATTRIBUTE_ID = "SCARAB_ISSUE_ATTRIBUTE_VALUE.ATTRIBUTE_ID";
          NUMERIC_VALUE = "SCARAB_ISSUE_ATTRIBUTE_VALUE.NUMERIC_VALUE";
          OPTION_ID = "SCARAB_ISSUE_ATTRIBUTE_VALUE.OPTION_ID";
          USER_ID = "SCARAB_ISSUE_ATTRIBUTE_VALUE.USER_ID";
          VALUE = "SCARAB_ISSUE_ATTRIBUTE_VALUE.VALUE";
          DELETED = "SCARAB_ISSUE_ATTRIBUTE_VALUE.DELETED";
          if (Torque.isInit())
        {
            try
            {
                getMapBuilder(AttributeValueMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(AttributeValueMapBuilder.CLASS_NAME);
        }
    }
    ...
    public static void addSelectColumns(Criteria criteria)
            throws TorqueException
    {
          criteria.addSelectColumn(VALUE_ID);
        ...
        throws TorqueException
    {
        try
        {
            ...
            AttributeValuePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setValueId(row.getValue(offset + 0).asLongObj());
                  obj.setIssueId(row.getValue(offset + 1).asLongObj());
                  obj.setAttributeId(row.getValue(offset + 2).asIntegerObj());
                  obj.setNumericValue(row.getValue(offset + 3).asIntegerObj());
                  obj.setOptionId(row.getValue(offset + 4).asIntegerObj());
                  obj.setUserId(row.getValue(offset + 5).asIntegerObj());
                  obj.setValue(row.getValue(offset + 6).asString());
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            Record row = (Record) records.get(i);
              results.add(AttributeValuePeer.row2Object(row, 1,
        ...
        throws TorqueException
    {
        ...
        {
              c = Class.forName(
                record.getValue(offset - 1 + 3).asString());
          }
        catch (Exception e)
        {
            throw new TorqueException(e);
        ...
        throws TorqueException
    {
        Criteria selectCriteria = new Criteria(DATABASE_NAME, 2);
                   selectCriteria.put(VALUE_ID, criteria.remove(VALUE_ID));
                                                                              // check for conversion from boolean to int
        if (criteria.containsKey(DELETED))
        {
            Object possibleBoolean = criteria.get(DELETED);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(AttributeValue obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(AttributeValue obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(AttributeValue obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(AttributeValue obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(AttributeValue obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(AttributeValue obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(AttributeValue obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( AttributeValue obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
            criteria.add(VALUE_ID, obj.getValueId());
    ...
    public static Criteria buildSelectCriteria( AttributeValue obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
                    criteria.add(VALUE_ID, obj.getValueId());
     ...
     */
    public static AttributeValue retrieveByPK(Long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AttributeValue retrieveByPK(Long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AttributeValue retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * actually need in AttributeValuePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
        ...
        throws TorqueException
    {
        ...
        AttributeValuePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        IssuePeer.addSelectColumns(criteria);


                        criteria.addJoin(AttributeValuePeer.ISSUE_ID,
            IssuePeer.ISSUE_ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            Record row = (Record) rows.get(i);
                    ...
                    AttributeValue obj1 = (AttributeValue) AttributeValuePeer
            ...
            {
                AttributeValue temp_obj1 = (AttributeValue)results.get(j);
                Issue temp_obj2 = (Issue)temp_obj1.getIssue();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                              temp_obj2.addAttributeValue(obj1);
                              break;
                }
            }
                      if (newObject)
        ...
        throws TorqueException
    {
        ...
        AttributeOptionPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(AttributeValuePeer.OPTION_ID,
        ...
        throws TorqueException
    {
        ...
        ScarabUserImplPeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(AttributeValuePeer.USER_ID,
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                                    temp_obj3.addAttributeValue(obj1);
                                    break;
                }
            }
                            if (newObject)
            ...
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                                    temp_obj4.addAttributeValue(obj1);
                                    break;
                }
            }
                            if (newObject)
