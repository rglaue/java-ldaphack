 ...
 */
public abstract class BaseFrequencyManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.Frequency";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.FrequencyManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of FrequencyManager.
     */
    public static FrequencyManager getManager()
    {
        return (FrequencyManager)
            Torque.getManager(FrequencyManager.MANAGED_CLASS,
                FrequencyManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>Frequency</code> value
     ...
     * @exception TorqueException if an error occurs
     */
    public static Frequency getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached Frequencys before loading
     * from storage.
     * @return a <code>Frequency</code> value
     * @exception TorqueException if an error occurs
     */
    public static Frequency getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Frequency getInstance(Integer id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Frequency getInstance(Integer id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(Frequency obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseFrequencyManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseFrequencyManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.Frequency");
    }

    /**
     * Get a fresh instance of a FrequencyManager
     */
    protected Frequency getInstanceImpl()
        throws TorqueException
    {
        Frequency obj = null;
        try
        {
            obj = (Frequency) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected Frequency getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Frequency) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected Frequency getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (Frequency) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of Frequencys based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of Frequencys
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(Frequency om)
        throws TorqueException
    {
        Criteria crit = FrequencyPeer
            .buildCriteria((Frequency)om);
        return FrequencyPeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return FrequencyPeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return FrequencyPeer.retrieveByPKs(ids);
    }
}
