 ...
 * extended all references should be to UserPreferenceManager
 */
public abstract class BaseUserPreferenceManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.UserPreference";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.UserPreferenceManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of UserPreferenceManager.
     */
    public static UserPreferenceManager getManager()
    {
        return (UserPreferenceManager)
            Torque.getManager(UserPreferenceManager.MANAGED_CLASS,
                UserPreferenceManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>UserPreference</code> value
     ...
     * @exception TorqueException if an error occurs
     */
    public static UserPreference getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached UserPreferences before loading
     * from storage.
     * @return a <code>UserPreference</code> value
     * @exception TorqueException if an error occurs
     */
    public static UserPreference getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static UserPreference getInstance(Integer id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static UserPreference getInstance(Integer id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(UserPreference obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseUserPreferenceManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseUserPreferenceManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.UserPreference");
    }

    /**
     * Get a fresh instance of a UserPreferenceManager
     */
    protected UserPreference getInstanceImpl()
        throws TorqueException
    {
        UserPreference obj = null;
        try
        {
            obj = (UserPreference) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected UserPreference getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (UserPreference) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected UserPreference getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (UserPreference) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of UserPreferences based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of UserPreferences
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(UserPreference om)
        throws TorqueException
    {
        Criteria crit = UserPreferencePeer
            .buildCriteria((UserPreference)om);
        return UserPreferencePeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return UserPreferencePeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return UserPreferencePeer.retrieveByPKs(ids);
    }
}
