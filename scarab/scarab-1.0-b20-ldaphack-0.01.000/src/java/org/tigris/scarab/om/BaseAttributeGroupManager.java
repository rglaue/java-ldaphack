 ...
 * extended all references should be to AttributeGroupManager
 */
public abstract class BaseAttributeGroupManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.AttributeGroup";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.AttributeGroupManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of AttributeGroupManager.
     */
    public static AttributeGroupManager getManager()
    {
        return (AttributeGroupManager)
            Torque.getManager(AttributeGroupManager.MANAGED_CLASS,
                AttributeGroupManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>AttributeGroup</code> value
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeGroup getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached AttributeGroups before loading
     * from storage.
     * @return a <code>AttributeGroup</code> value
     * @exception TorqueException if an error occurs
     */
    public static AttributeGroup getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeGroup getInstance(Integer id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static AttributeGroup getInstance(Integer id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(AttributeGroup obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseAttributeGroupManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseAttributeGroupManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.AttributeGroup");
    }
    ...
    protected AttributeGroup getInstanceImpl()
        throws TorqueException
    {
        AttributeGroup obj = null;
        try
        {
            obj = (AttributeGroup) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected AttributeGroup getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (AttributeGroup) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected AttributeGroup getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (AttributeGroup) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of AttributeGroups based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of AttributeGroups
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(AttributeGroup om)
        throws TorqueException
    {
        Criteria crit = AttributeGroupPeer
            .buildCriteria((AttributeGroup)om);
        return AttributeGroupPeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return AttributeGroupPeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return AttributeGroupPeer.retrieveByPKs(ids);
    }
}
