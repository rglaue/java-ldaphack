    ...
    extends AbstractBaseManager
{
    ...
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.Activity";
     ...
     * the configuration.
     *
     * @return an implementation of ActivityManager.
     */
    public static ActivityManager getManager()
    {
        return (ActivityManager)
            Torque.getManager(ActivityManager.MANAGED_CLASS,
                ActivityManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>Activity</code> value
     ...
     * @exception TorqueException if an error occurs
     */
    public static Activity getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached Activitys before loading
     * from storage.
     * @return a <code>Activity</code> value
     * @exception TorqueException if an error occurs
     */
    public static Activity getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Activity getInstance(Long id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Activity getInstance(Long id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(Activity obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseActivityManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseActivityManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.Activity");
    }

    /**
     * Get a fresh instance of a ActivityManager
     */
    protected Activity getInstanceImpl()
        throws TorqueException
    {
        Activity obj = null;
        try
        {
            obj = (Activity) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected Activity getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Activity) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected Activity getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (Activity) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of Activitys based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of Activitys
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(Activity om)
        throws TorqueException
    {
        Criteria crit = ActivityPeer
            .buildCriteria((Activity)om);
        return ActivityPeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return ActivityPeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return ActivityPeer.retrieveByPKs(ids);
    }
}
