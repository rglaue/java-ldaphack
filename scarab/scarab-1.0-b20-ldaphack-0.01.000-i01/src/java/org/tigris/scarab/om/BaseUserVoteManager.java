 ...
 */
public abstract class BaseUserVoteManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.UserVote";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.UserVoteManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of UserVoteManager.
     */
    public static UserVoteManager getManager()
    {
        return (UserVoteManager)
            Torque.getManager(UserVoteManager.MANAGED_CLASS,
                UserVoteManager.DEFAULT_MANAGER_CLASS);
    }

    /**
     * Static accessor for the @see #getInstanceImpl().
     *
     * @return a <code>UserVote</code> value
     * @exception TorqueException if an error occurs
     */
    public static UserVote getInstance()
     ...
     * @exception TorqueException if an error occurs
     */
    public static UserVote getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached UserVotes before loading
     * from storage.
     * @return a <code>UserVote</code> value
     * @exception TorqueException if an error occurs
     */
    public static UserVote getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(UserVote obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseUserVoteManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseUserVoteManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.UserVote");
    }
     ...
     */
    protected UserVote getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (UserVote) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected UserVote getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (UserVote) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of UserVotes based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of UserVotes
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(UserVote om)
        throws TorqueException
    {
        Criteria crit = UserVotePeer
            .buildCriteria((UserVote)om);
        return UserVotePeer.doSelect(crit).size() > 0;
    }
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return UserVotePeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return UserVotePeer.retrieveByPKs(ids);
    }
}
