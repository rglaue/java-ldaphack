...
/**
 */
public abstract class BaseRModuleOptionPeer
    extends BasePeer
{
    ...
    public static final String TABLE_NAME = "SCARAB_R_MODULE_OPTION";
    ...
    {
        return getMapBuilder(RModuleOptionMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
          MODULE_ID = "SCARAB_R_MODULE_OPTION.MODULE_ID";
          ISSUE_TYPE_ID = "SCARAB_R_MODULE_OPTION.ISSUE_TYPE_ID";
          OPTION_ID = "SCARAB_R_MODULE_OPTION.OPTION_ID";
          DISPLAY_VALUE = "SCARAB_R_MODULE_OPTION.DISPLAY_VALUE";
          ACTIVE = "SCARAB_R_MODULE_OPTION.ACTIVE";
          PREFERRED_ORDER = "SCARAB_R_MODULE_OPTION.PREFERRED_ORDER";
          WEIGHT = "SCARAB_R_MODULE_OPTION.WEIGHT";
          if (Torque.isInit())
        {
            try
            {
                getMapBuilder(RModuleOptionMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(RModuleOptionMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static RModuleOption row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            RModuleOption obj = (RModuleOption) cls.newInstance();
            RModuleOptionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                obj.setModuleId(row.getValue(offset + 0).asIntegerObj());
                  ...
                  obj.setOptionId(row.getValue(offset + 2).asIntegerObj());
                  obj.setDisplayValue(row.getValue(offset + 3).asString());
                  obj.setActive(row.getValue(offset + 4).asBoolean());
                  obj.setOrder(row.getValue(offset + 5).asInt());
                  obj.setWeight(row.getValue(offset + 6).asInt());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            Record row = (Record) records.get(i);
              results.add(RModuleOptionPeer.row2Object(row, 1,
                RModuleOptionPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(RModuleOption obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(RModuleOption obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(RModuleOption obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(RModuleOption obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(RModuleOption) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(RModuleOption obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(RModuleOption) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(RModuleOption obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(RModuleOption) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(RModuleOption obj, Connection con)
        throws TorqueException
    {
        ...
        Criteria criteria = new Criteria();
          SimpleKey[] keys = (SimpleKey[])pk.getValue();
                    criteria.add(MODULE_ID, keys[0]);
                      ...
                      criteria.add(OPTION_ID, keys[2]);
                    return criteria;
     }

    /** Build a Criteria object from the data object for this peer */
    public static Criteria buildCriteria( RModuleOption obj )
    {
    ...
    public static Criteria buildSelectCriteria( RModuleOption obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
                      criteria.add(MODULE_ID, obj.getModuleId());
                          criteria.add(ISSUE_TYPE_ID, obj.getIssueTypeId());
     ...
     */
    public static RModuleOption retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        RModuleOption retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RModuleOption retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        else
        {
            ...
            while (iter.hasNext())
            {
                ...
                SimpleKey[] keys = (SimpleKey[])pk.getValue();
                        ...
                        OPTION_ID, keys[2], Criteria.EQUAL);
                                    c1.and(c2);
                          criteria.or(c0);
            }
     ...
     *
       ...
       */
    public static RModuleOption retrieveByPK(
       Integer module_id
    ...
    /**
     * selects a collection of RModuleOption objects pre-filled with their
     * AttributeOption objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RModuleOptionPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
        ...
        throws TorqueException
    {
        ...
        RModuleOptionPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AttributeOptionPeer.addSelectColumns(criteria);


                        criteria.addJoin(RModuleOptionPeer.OPTION_ID,
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            Record row = (Record) rows.get(i);
                            ...
                            Class omClass = RModuleOptionPeer.getOMClass();
                    RModuleOption obj1 = (RModuleOption) RModuleOptionPeer
            ...
            {
                RModuleOption temp_obj1 = (RModuleOption)results.get(j);
                AttributeOption temp_obj2 = (AttributeOption)temp_obj1.getAttributeOption();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                              temp_obj2.addRModuleOption(obj1);
                              break;
                }
            }
                      if (newObject)
            {
                obj2.initRModuleOptions();
                obj2.addRModuleOption(obj1);
            }
                      results.add(obj1);
        }
        return results;
        ...
        throws TorqueException
    {
        ...
        ScarabModulePeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(RModuleOptionPeer.MODULE_ID,
        ...
        throws TorqueException
    {
        ...
        IssueTypePeer.addSelectColumns(criteria);
                        ...
                        criteria.addJoin(RModuleOptionPeer.ISSUE_TYPE_ID,
    ...
    /**
     * selects a collection of RModuleOption objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                                    temp_obj3.addRModuleOption(obj1);
                                    break;
                }
            }
                            if (newObject)
            {
                obj3.initRModuleOptions();
                obj3.addRModuleOption(obj1);
            }
                                                                results.add(obj1);
        }
        return results;
