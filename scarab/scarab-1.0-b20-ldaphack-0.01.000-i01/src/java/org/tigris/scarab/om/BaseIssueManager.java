 ...
 * extended all references should be to IssueManager
 */
public abstract class BaseIssueManager
    extends AbstractBaseManager
{
    /** The name of the manager */
    protected static String MANAGED_CLASS = "org.tigris.scarab.om.Issue";

    /** The name of our class to pass to Torque as the default manager. */
    protected static String DEFAULT_MANAGER_CLASS
        = "org.tigris.scarab.om.IssueManager";

    /**
     * Retrieves an implementation of the manager, based on the settings in
     * the configuration.
     *
     * @return an implementation of IssueManager.
     */
    public static IssueManager getManager()
    {
        return (IssueManager)
            Torque.getManager(IssueManager.MANAGED_CLASS,
                IssueManager.DEFAULT_MANAGER_CLASS);
    }
     ...
     * @exception TorqueException if an error occurs
     */
    public static Issue getInstance(ObjectKey id)
        throws TorqueException
    {
     ...
     *
     * @param id an <code>ObjectKey</code> value
     * @param fromCache if true, look for cached Issues before loading
     * from storage.
     * @return a <code>Issue</code> value
     * @exception TorqueException if an error occurs
     */
    public static Issue getInstance(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Issue getInstance(Long id)
        throws TorqueException
    {
     ...
     * @exception TorqueException if an error occurs
     */
    public static Issue getInstance(Long id, boolean fromCache)
        throws TorqueException
    {
    ...
    public static boolean exists(Issue obj)
        throws TorqueException
    {
    ...
    /**
     * Creates a new <code>BaseIssueManager</code> instance.
     *
     * @exception TorqueException if an error occurs
     */
    public BaseIssueManager()
        throws TorqueException
    {
        setClassName("org.tigris.scarab.om.Issue");
    }

    /**
     * Get a fresh instance of a IssueManager
     */
    protected Issue getInstanceImpl()
        throws TorqueException
    {
        Issue obj = null;
        try
        {
            obj = (Issue) getOMInstance();
        }
        catch (Exception e)
        {
     ...
     */
    protected Issue getInstanceImpl(ObjectKey id)
        throws TorqueException
    {
        return (Issue) getOMInstance(id);
    }
     ...
     * from storage.
     */
    protected Issue getInstanceImpl(ObjectKey id, boolean fromCache)
        throws TorqueException
    {
        return (Issue) getOMInstance(id, fromCache);
    }

    /**
     * Gets a list of Issues based on id's.
     *
     * @param ids a List of <code>ObjectKeys</code> value
     * @return a <code>List</code> of Issues
     * @exception TorqueException if an error occurs
     */
     ...
     */
    protected boolean existsImpl(Issue om)
        throws TorqueException
    {
        Criteria crit = IssuePeer
            .buildCriteria((Issue)om);
    ...
    protected Persistent retrieveStoredOM(ObjectKey id)
        throws TorqueException
    {
        return IssuePeer.retrieveByPK(id);
    }
    ...
    protected List retrieveStoredOMs(List ids)
        throws TorqueException
    {
        return IssuePeer.retrieveByPKs(ids);
    }
}
